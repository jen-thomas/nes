...
class ExportQuestionnaireTest(ExportTestCase):
    ...
    def test_participant_age_in_responses_is_age_when_questionnaire_was_filled_2(self):
        ...
        data = {
            ...
            'headings': ['code'],
            'to[]': [
                '0*915325*First Survey*acquisitiondate*acquisitiondate',
                '0*915325*First Survey*firstQuestion*firstQuestion',
                '0*915325*First Survey*secondQuestion*secondQuestion'
            ],
            'patient_selected': ['age*age'],
            'responses': ['short'],
        }
